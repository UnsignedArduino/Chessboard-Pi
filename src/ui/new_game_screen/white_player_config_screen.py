...
class WhitePlayerConfigScreen(Screen):
    def __init__(self, **kwargs):
        super().__init__(**kwargs,
                         name="white_player_config_screen")
        layout = BoxLayout(orientation="vertical")

        layout.add_widget(
            Label(text="White pieces player will be..."))
    ...
    def set_as_human_and_switch_to_new_game_screen(self, _):
        ...
        new_game_screen.white_player_type = PlayerType.HUMAN
        new_game_screen.update_white_player_config_button()
        self.switch_to_new_game_screen(_)

    def set_as_engine_and_switch_to_new_game_screen(self, _):
        new_game_screen = self.manager.get_screen("new_game_screen")
        new_game_screen.white_player_type = PlayerType.ENGINE
        new_game_screen.update_white_player_config_button()
        self.switch_to_new_game_screen(_)
